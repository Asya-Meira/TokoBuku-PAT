            ...
            <div class="dropdown">
                ...
                Inputan
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="inputan/InputanDistributor.php">Input Distributor</a></li>
                        <li><a class="dropdown-item" href="inputan/input-buku.php">Input Buku</a></li>
                    </ul>
                    <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                Tambah
                </button>
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="tambah/input-pasok.php">Input Pasok Buku</a></li>
                    </ul>
                <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                Laporan
                </button>
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="laporan/data-buku.php">Semua Data Buku</a></li>
                        ...
                        <li><a class="dropdown-item" href="laporan/buku-tidak-terjual.php">Buku Yang Tidak Pernah Terjual</a></li>
