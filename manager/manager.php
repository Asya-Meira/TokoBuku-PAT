            ...
            <div class="dropdown">
                ...
                Laporan
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        ...
                        <li><a class="dropdown-item" href="laporan/penjualan-pertanggal.php">Penjualan Pertanggal</a></li>
                        ...
                        <li><a class="dropdown-item" href="laporan/buku-yang-sering-terjual.php">Buku Yang Sering Terjual</a></li>
                        <li><a class="dropdown-item" href="laporan/buku-yang-tidak-pernah-terjual.php">Buku Yang Tidak Pernah Terjual</a></li>
