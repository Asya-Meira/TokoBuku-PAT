        ...
        <div class="card-header">
            ...
            <a href="#" type="button" class="btn btn-success">Export Excel</a>
                ...
                <tr>
    	            ...
    	            <td colspan="1" align="left"><strong>20 Transaksi</strong></td>
    	            <td colspan="1" align="right"><strong>Jumlah</strong></td>
    	            <td colspan="1" align="right"><strong>2004 buku</strong></td>
    	            <td colspan="1" align=""><strong></strong></td>
    	            <td colspan="1" align=""><strong></strong></td>
    	            <td colspan="1" align="right"><strong>Grand Total</strong></td>
    	            <td colspan="1" align="right"><strong>123.235.674</strong></td>
                </tr>             
                </table>                       
            </div>
        </div>
